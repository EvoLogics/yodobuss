...
#OpenCV
LOCAL_CONF_OPT   += 'IMAGE_INSTALL_append = " db-agent packagegroup-gstreamer packagegroup-opencv"'
# Enable all 6 cores by setting nvpmodule to mode 2
LOCAL_CONF_OPT   += 'NVPMODEL_CONFIG_DEFAULT = "2"'
# Sonobot number
LOCAL_CONF_OPT   += 'EVOSN = "5189"'
# Add IP Alias
LOCAL_CONF_OPT   += 'IP_ALIAS = "172.16.219.8/24"'
