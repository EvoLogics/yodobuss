...
LOCAL_CONF_OPT += 'IMAGE_INSTALL_append = " dune-usbl-buoy dune-usbl-buoy-etc dune-usbl-buoy-default dune-usbl-buoy-www comm-config"'

LOCAL_CONF_OPT += 'IMAGE_INSTALL_append = " haproxy"'
