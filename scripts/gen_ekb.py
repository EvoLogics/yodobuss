...
# Documentation https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-108r1.pdf
...
def main():
    ...
    parser.add_argument('-in_sym_key', nargs=1, required=True, help="16-byte symmetric key file in hex format used for kernel encryption")
